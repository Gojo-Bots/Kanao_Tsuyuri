...
You get some coins for every user that join with your link, which will further used to buy stuffs.

/mylink : To get previous genrated link of the chat by you.
/profile <user id | username> : To get you information.
/myprofile : To check your coins
/premium: To get link of premium channel. 
/buy : To buy stuffs. 
